        ...
        <div className="min-h-screen bg-background flex flex-col">
          <header className="bg-white border-b border-border sticky top-0 z-10 shadow-sm">
            <div className="max-w-3xl mx-auto px-4 h-14 flex items-center justify-between">
              ...
              <nav className="text-sm text-muted-foreground flex gap-5 font-medium">
                <a href="#" className="hover:text-primary transition-colors">계산기</a>
                <a href="#" className="hover:text-primary transition-colors">이용안내</a>
              </nav>
            </div>
          </header>
          ...
          <footer className="bg-muted py-8 mt-auto border-t border-border text-center text-sm text-muted-foreground">
            ...
            <div className="mt-3 flex justify-center gap-4 text-xs">
              ...
              <a href="/privacy" className="hover:text-foreground transition-colors font-semibold">개인정보처리방침</a>
            </div>
